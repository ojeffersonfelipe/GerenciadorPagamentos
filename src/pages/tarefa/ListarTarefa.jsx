...
const initialRows = [
  createData(1, 'Transferência', 'Transferir R$ 12.000,00', '2022-01-01', '2022-01-02', 'Concluída', 'BB Asset'),
  createData(2, 'Transferência', 'Transferir R$ 5.000,00', '2022-01-03', '2022-01-04', 'Em Andamento', 'Bradesco'),
  createData(3, 'Transferência', 'Transferir R$ 20.000,00', '2022-01-04', '2022-01-05', 'Em Andamento', 'BTG Pactual'),
  createData(4, 'Transferência', 'Transferir R$ 350.000,00', '2022-01-05', '2022-01-06', 'Em Andamento', 'Genial'),
  createData(5, 'Transferência', 'Transferir R$ 60.000,00', '2022-01-06', '2022-01-07', 'Em Andamento', 'BTG Pactual'),
  createData(6, 'Transferência', 'Transferir R$ 600.000,00', '2022-01-07', '2022-01-08', 'Aguardando', 'Bradesco'),
];
...
const ListarTarefa = () => {
  ...
  const handleDeletar = (id) => {
    ...
    <Card>
        <CardHeader
          title="Pagamentos"
          subheader="Listagem de Pagamentos"
        /> 
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                <TableRow>
                    ...
                    <TableCell align="right">Conta Origem</TableCell>
        ...
        <CardActions>
            <Button size="small" variant="contained" onClick={handleOpen}>Novo Pagamento</Button>
