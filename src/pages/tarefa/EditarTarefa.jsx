  ...
  return(
    <Grid container spacing={2}>
      <Card sx={style}>
        <CardHeader
          title="Pagamentos"
          subheader="Edição de Pagamentos"
        /> 
        <CardContent sx={{
          width: '95%',
          maxWidth: '100%',
          ...
          <Grid container spacing={2} mt={1}>
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_inicio_helper_text">Início</FormHelperText>
              </FormControl>
            </Grid>  
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_fim_helper_text">Fim</FormHelperText>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Recurso 1'}>BTG Pactual</MenuItem>
                  <MenuItem value={'Recurso 2'}>XP Investimentos</MenuItem>
                  <MenuItem value={'Recurso 3'}>Bradesco</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
